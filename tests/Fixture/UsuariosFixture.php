...
class UsuariosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'usuarios_ibfk_1' => ['type' => 'foreign', 'columns' => ['tipo_documento'], 'references' => ['tipo_documentos', 'id_documento'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'usuarios_ibfk_2' => ['type' => 'foreign', 'columns' => ['id_ciudad'], 'references' => ['ciudades', 'idCiudades'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'estado' => 1,
            'fecha_inicio' => '2016-01-19 02:25:30',
            'codigo' => 1,
            'create_at' => '2016-01-19 02:25:30',
            'update_at' => '2016-01-19 02:25:30'
        ],
    ];
}
